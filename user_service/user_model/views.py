...
def data_insert(fname, lname, email, mobile, password, address, staff):
    user_data = user_registration(fname = fname, lname = lname, email =
    email, mobile = mobile, password = password, address = address, staff=staff)
    user_data.save()
    return 1
